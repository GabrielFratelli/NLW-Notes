...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleStartRecording() {
    ...
    speechRecognition.lang = "pt-BR"; // linguagem da gravação
    speechRecognition.continuous = true; // não vai parar de gravar até você decidir parar
    speechRecognition.maxAlternatives = 1; // traz somente a alternativa que condiz com oque você disse na gravação
    speechRecognition.interimResults = true; // vai trazendo o resultado enquanto vai falando e não quando terminar de falar
              ...
              {shouldShowOnboarding ? (
                <p className="text-sm leading-6 text-slate-400">
                  ...
                  <button
                    ...
                    className="font-medium text-lime-400 hover:"
                  >
                    gravando uma nota
                  </button>{" "}
